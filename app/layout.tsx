...
export const metadata: Metadata = {
  ...
  description: 'شركة Triple Point متخصصة في حلول تقنية متكاملة للمؤسسات السعودية — أنظمة قاعات الاجتماعات، إدارة الطوابير، الأمن والمراقبة، والمنازل الذكية.',
  keywords: ['حلول تقنية', 'المملكة العربية السعودية', 'أنظمة مراقبة', 'إدارة الطوابير', 'قاعات الاجتماعات', 'منازل ذكية', 'Triple Point'],
  ...
  alternates: {
    ...
    languages: { 'ar-SA': 'https://triplepointsa.com', 'en-US': 'https://triplepointsa.com' },
  },
}
