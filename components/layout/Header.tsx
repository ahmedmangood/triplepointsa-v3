        ...
        <div className="flex items-center justify-between h-18 py-3">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:block">
              <span className="block text-white font-bold text-lg leading-none font-display">{brandName}</span>
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <Link href="/" className="nav-link px-4 py-2 text-sm font-medium text-white/80 hover:text-gold-500 transition-colors rounded-lg hover:bg-white/5">
              {t.nav.home}
            </Link>
            <Link href="/about" className="nav-link px-4 py-2 text-sm font-medium text-white/80 hover:text-gold-500 transition-colors rounded-lg hover:bg-white/5">
              {t.nav.about}
            </Link>
            ...
            <Link href="/projects" className="nav-link px-4 py-2 text-sm font-medium text-white/80 hover:text-gold-500 transition-colors rounded-lg hover:bg-white/5">
              {t.nav.projects}
            </Link>
            <Link href="/contact" className="nav-link px-4 py-2 text-sm font-medium text-white/80 hover:text-gold-500 transition-colors rounded-lg hover:bg-white/5">
              {t.nav.contact}
            </Link>
          </nav>
              ...
              {[
                ...
                <Link
                  ...
                  className={`block px-4 py-2.5 text-sm font-medium rounded-lg transition-colors ${
                    item.href.includes('services/') ? 'ps-8 text-white/60' : 'text-white/80'
