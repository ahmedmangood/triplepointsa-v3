...
export default function Footer() {
  ...
  const serviceLinks = [
    ...
    },
    {
      ...
      label: isRTL ? "إدارة الطوابير" : "Queue Management",
    },
    {
    ...
    },
    {
      ...
      label: isRTL ? "المنازل الذكية" : "Smart Homes",
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg border border-gold-500/20 bg-white shadow-lg shadow-black/20 flex items-center justify-center">
                <Image
                  src="/logo.png"
                  alt={`${brandName} logo`}
                  width={80}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm text-white/60">
                <Phone size={15} className="text-gold-500 flex-shrink-0" />
                <span dir="ltr">{t.contactPage.info.phone2}</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-white/60">
